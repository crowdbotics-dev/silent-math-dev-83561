"""
Django settings for silent_math_dev_83561 project.
...
ROOT_URLCONF = 'silent_math_dev_83561.urls'
...
WSGI_APPLICATION = 'silent_math_dev_83561.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_math_dev_83561 API",
    "DESCRIPTION": "API documentation for silent_math_dev_83561 App",
    "VERSION": "v1",
}
